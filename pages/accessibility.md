...
Every code change to this site runs through an automated [Accessibility insights for Web](https://accessibilityinsights.io/docs/web/overview/) scan before it can be published publicly. Several pages are scanned daily using [axe-core](https://github.com/dequelabs/axe-core), [html-validate](https://html-validate.org/), [IBM Equal Access Accessibility Checker](https://www.ibm.com/able/toolkit/verify/automated/), and [some custom tests](https://github.com/jsnmrs/how-you-doin/blob/main/scanners/custom.js) with results posted automatically to [my own dashboard](https://code.jasonmorris.com/how-you-doin/). I explore the site occasionally with JAWS, NVDA, or VoiceOver to hear what I hope is a pleasant experience for screen reader users. I use Orca once a year, when I boot my Ubuntu VM.
